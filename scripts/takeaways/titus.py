#!/usr/bin/env python3
"""Written one-line takeaways for Titus."""
...
TAKEAWAYS = {
    ...
    '1:5': "Titus was left behind to finish what Paul started. Unfinished work was part of the plan, not a failure of it.",
    '1:6': "Elders are to be appointed \"in every city,\" and the qualifying evidence is a household anyone in that city could observe.",
    '1:7': "\"The steward of God\" — the bishop manages what belongs to someone else, which is why selfwill disqualifies him.",
    '1:8': "After six things he must not be, six things he must: hospitality heads the list, before sobriety or justice.",
    '1:9': "The faithful word is held \"as he hath been taught,\" and the ability it produces is for exhorting and for answering objectors.",
    '1:10': "\"Vain talkers\" — the problem in Crete is not organised heresy but men who will not stop talking.",
    '1:11': "\"Whose mouths must be stopped\" — the damage is by household, and the motive named is money.",
    '1:12': "Paul quotes a Cretan poet against Cretans. The witness that stings most is the one from inside.",
    '1:13': "\"This witness is true.\" The sharp rebuke is ordered for a purpose: that they may be sound in the faith.",
    '1:14': "Fables and human commandments are what turn men from truth — the additions do the damage, not open denial.",
    '1:15': "\"Unto the pure all things are pure.\" Defilement is relocated from the object to the mind that handles it.",
    '1:16': "Profession and works are set against each other, and the works are allowed to give the verdict.",

    # ---- Chapter 2 ----
    '2:1': "Sound doctrine has things that \"become\" it — a matching conduct — and Titus is to speak those, not only the doctrine.",
    '2:2': "Old men are given something to grow into. Age is not treated as arrival.",
    '2:3': "Older women are assumed to be teaching; the question is whether they are teaching good things or carrying accusations.",
    '2:4': "The younger women learn from the older ones, not from Titus. The teaching is delegated by household, not centralised.",
    '2:5': "\"That the word of God be not blasphemed.\" Domestic conduct is treated as testimony a watching island will read.",
    '2:6': "One word for the young men, and it is the word given to every other group: sober-minded.",
    ...
    # ---- Chapter 3 ----
    '3:1': "Christians are to be \"ready to every good work\" toward a state they did not choose and cannot vote out.",
